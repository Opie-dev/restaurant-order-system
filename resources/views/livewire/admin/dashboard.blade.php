    ...
    @else
        ...
        <div class="max-w-4xl">
            ...
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Welcome to Your Store Dashboard!</h1>
                <p class="text-gray-600">Let's get your store set up and ready to accept orders.</p>
            </div>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <span class="text-2xl font-bold text-indigo-600">{{ $this->completionPercentage }}%</span>
                </div>
                ...
                <p class="text-sm text-gray-600">
                    Complete all steps below to unlock your full dashboard and start accepting orders.
                </p>
            </div>

            <!-- Onboarding Steps -->
            <div class="space-y-4 mb-8">
                @foreach($this->onboardingSteps as $key => $step)
                    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow duration-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <!-- Step Icon -->
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center mr-4 {{ $step['completed'] ? 'bg-indigo-100' : 'bg-gray-100' }}">
                                    @if($step['completed'])
                                ...
                                <!-- Step Content -->
                                <div>
                                    <h3 class="text-lg font-semibold {{ $step['completed'] ? 'text-indigo-900' : 'text-gray-900' }}">
                                        {{ $step['title'] }}
                                    </h3>
                                    <p class="text-sm {{ $step['completed'] ? 'text-indigo-600' : 'text-gray-600' }}">
                                        {{ $step['description'] }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                @else
                                    <a href="{{ isset($step['route_params']) ? route($step['route'], $step['route_params']) : route($step['route']) }}" 
            ...
            @if($this->onboardingComplete)
                <div class="text-center">
                    <button wire:click="completeOnboarding" 
                            class="inline-flex items-center px-8 py-3 border border-transparent text-lg font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors duration-200">
