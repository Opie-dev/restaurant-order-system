                    ...
                    <div class="max-w-md mx-auto">
                        ...
                        <form wire:submit.prevent="register" class="space-y-5">
                            <div>
                                ...
                                <input id="name" type="text" wire:model.blur="name" required autofocus class="mt-1 block w-full rounded-lg border-2 border-gray-300 px-3 py-2.5 shadow-sm focus:border-purple-500 focus:ring-purple-500" />
                                @error('name') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
                            </div>

                            <div>
                                <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                                <input id="email" type="email" wire:model.blur="email" required autocomplete="username" class="mt-1 block w-full rounded-lg border-2 border-gray-300 px-3 py-2.5 shadow-sm focus:border-purple-500 focus:ring-purple-500" />
                                @error('email') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
                            </div>

                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                                <input id="password" type="password" wire:model.blur="password" required autocomplete="new-password" class="mt-1 block w-full rounded-lg border-2 border-gray-300 px-3 py-2.5 shadow-sm focus:border-purple-500 focus:ring-purple-500" />
                                @error('password') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
                            </div>

                            <div>
                                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Confirm Password</label>
                                <input id="password_confirmation" type="password" wire:model.blur="password_confirmation" required autocomplete="new-password" class="mt-1 block w-full rounded-lg border-2 border-gray-300 px-3 py-2.5 shadow-sm focus:border-purple-500 focus:ring-purple-500" />
